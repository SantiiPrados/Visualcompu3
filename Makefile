...
PROJECTPATH = E:/Programacion/Proyectos/BaseProject

# Configure aqui directorio del COMPILADOR ARM-GCC para MBED
...
COMPILERDIR = E:/Cosas/Programas/programacion/Compiladores/gcc-arm-none-eabi-6-2017-q2-update-win32/bin
...
OBJECTS += main.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/analogin_device.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/except.o
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/flash_api.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/hal_tick_overrides.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/mbed_crc_api.o
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/mbed_fault_handler.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/mbed_tz_context.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM/qspi_api.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1598547397.756658
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1598547397.756658
...
ASM_FLAGS += -I../mbed
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TOOLCHAIN_GCC_ARM
ASM_FLAGS += -I../mbed/drivers
ASM_FLAGS += -I../mbed/hal
ASM_FLAGS += -I../mbed/platform
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/b/b4e4e93a355cb51b46943e8445b4acd2/Test103mbed/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
